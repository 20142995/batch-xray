...
RUN wget `curl https://api.github.com/repos/chaitin/rad/releases/latest  | grep -o https://github.com/chaitin/rad/releases/download/[0-9]\.[0-9]/rad_linux_amd64.zip`

RUN unzip xray_linux_amd64.zip

RUN unzip rad_linux_amd64.zip

RUN ./xray_linux_amd64  genca
